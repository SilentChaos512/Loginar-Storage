...
public abstract class AbstractLoginarUrnScreen<T extends AbstractLoginarUrnMenu> extends AbstractContainerScreen<T> {
    public static final ResourceLocation TEXTURE_URN_9X6 = LoginarMod.getId("textures/gui/urn.png");
    public static final ResourceLocation TEXTURE_URN_9X9 = LoginarMod.getId("textures/gui/urn_9x9.png");
    public static final ResourceLocation TEXTURE_URN_12X9 = LoginarMod.getId("textures/gui/urn_12x9.png");
    public static final ResourceLocation TEXTURE_URN_SWAP_9X6 = LoginarMod.getId("textures/gui/urn.png");
    public static final ResourceLocation TEXTURE_URN_SWAP_9X9 = LoginarMod.getId("textures/gui/urn_9x9.png");
    public static final ResourceLocation TEXTURE_URN_SWAP_12X9 = LoginarMod.getId("textures/gui/urn_12x9.png");
    ...
    protected ResourceLocation guiTexture = TEXTURE_URN_9X6;
    ...
    public static ResourceLocation getGuiTexture(UrnSize size) {
        if (size.height() == 9) {
            if (size.width() == 12) {
    ...
    public static ResourceLocation getSwapGuiTexture(UrnSize size) {
        if (size.height() == 9) {
            if (size.width() == 12) {
