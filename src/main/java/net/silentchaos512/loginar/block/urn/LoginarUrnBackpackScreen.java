...
public class LoginarUrnBackpackScreen extends AbstractLoginarUrnScreen<LoginarUrnBackpackMenu> {
    ...
    protected void renderBg(GuiGraphics graphics, float p_97788_, int p_97789_, int p_97790_) {
        ...
        if (this.isFlexibleTexture()) {
            graphics.blit(this.guiTexture, i, j, 0, 0, this.imageWidth, this.containerRows * 18 + 17);
            graphics.blit(this.guiTexture, i, j + this.containerRows * 18 + 17, 0, 126, this.imageWidth, 96);
        } else {
